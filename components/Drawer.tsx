      ...
      `}>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <span className="bg-white/5 text-white/40 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border border-white/5">
              The Observation
            </span>
            {isCritical && (
        ...
        {isCritical && (
          <div className="p-6 bg-yellow-500/10 border-2 border-yellow-500/20 rounded-2xl flex gap-4 items-start">
             ...
             <div className="space-y-1">
               ...
               <p className="text-white/80 text-xs font-bold leading-snug">
                 Visual markers alone cannot confirm safety. Use a probe thermometer to verify internal temperature.
               </p>
             </div>
          </div>
        )}
